...
namespace vwze {
    namespace dao {
        ...
        class TodoDAO : public CommonDAO {
        private:
            static TodoDAO * dao;
            static boost::mutex mtx;
            void loadColumns(tntdb::Row &, vwze::entity::Todo *);
            void setColumns(tntdb::Statement &, const vwze::entity::Todo *);
        public:
            ~TodoDAO();
            static TodoDAO * getInstance(void);
            vwze::entity::Todo * insert(tntdb::Connection &, vwze::entity::Todo *);
            std::list<vwze::entity::Todo *> query(tntdb::Connection &, tntdb::Statement &);
            vwze::entity::Todo * read(tntdb::Connection &, const std::string &);
            tntdb::Statement::size_type remove(tntdb::Connection &, const std::string &);
            vwze::entity::Todo * update(tntdb::Connection &, vwze::entity::Todo *);
        };

        class VkostenDAO : public CommonDAO {
        private:
            static VkostenDAO * dao;
            static boost::mutex mtx;
            void loadColumns(tntdb::Row &, vwze::entity::Vkosten *);
            void setColumns(tntdb::Statement &, const vwze::entity::Vkosten *);
        public:
            ~VkostenDAO();
            static VkostenDAO * getInstance(void);
            vwze::entity::Vkosten * insert(tntdb::Connection &, vwze::entity::Vkosten *);
            std::list<vwze::entity::Vkosten *> query(tntdb::Connection &, tntdb::Statement &);
        };
