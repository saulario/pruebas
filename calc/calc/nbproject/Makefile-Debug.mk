...
LDLIBSOPTIONS=-llog4cxx -ltntdb -lcxxtools -lboost_system
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/calc: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/calc ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/Tarificador.o: Tarificador.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tarificador.o Tarificador.cpp
...
${OBJECTDIR}/vwze_dao.o: vwze_dao.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/vwze_dao.o vwze_dao.cpp

${OBJECTDIR}/vwze_entity.o: vwze_entity.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/vwze_entity.o vwze_entity.cpp
